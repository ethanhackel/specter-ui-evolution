...
import { ArrowLeft, RefreshCw, User, Lock, ShieldCheck } from "lucide-react";
        ...
        <div className="space-y-4 sm:space-y-5">
          <div>
            <div className="flex items-center gap-2 mb-1.5 sm:mb-2">
              ...
              <span className="text-[0.65rem] sm:text-xs font-mono tracking-[0.2em] text-muted-foreground">USERNAME OR EMAIL</span>
            </div>
            <input
              type="text"
